...
<body>
      ...
      <nav id="overlay">
            ...
            <div class="overlaymenu">
                  <a href="index.php" class="menu-link active-page" id="menuItem1">PORTFOLIO</a>
                  <a href="cv.html" class="menu-link" id="menuItem2">MIJN CV</a>
            </div>
      </nav>
      ...
      <div class="container">
            ...
            <div class="page-sidebar">
                  ...
                  <div class="sidebar-content">
                        <p>
                              Recent afgestudeerd van de HBO opleiding ICT &amp; Media design en vanaf 8 Oktober
                              beschikbaar als Front End Development Trainee via YoungCapital Professionals B.V.
                        </p>
                  </div>
                  <!-- Sidebar - Footer -->
